...
// onSubmit() { // const { userInfo } = this; // console.log(userInfo.id,
userInfo.password); // if (userInfo.id.length > 0 && userInfo.password.length >
0) { // // this.isLogined = true; // this.$store.commit("isLogin"); //
this.confirm(); // } else { // alert("입력해주세요"); // } //
